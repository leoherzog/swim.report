...
// Every api.weather.gov request routes through one fetchNwsJson wrapper that
// passes NWS_TIMEOUT_MS, so a single hung socket cannot run the hourly cron to
// the 900 s scheduled ceiling. A wall-clock deadline cannot rescue it, because
// deadlines are checked between units of work, never inside a pending fetch.
