...
describe("wave-forecast section", () => {
  ...
  it("renders the strip as a flex row of proportional colored segments", () => {
    ...
    expect(html).toContain("style=\"flex: 5 5 0%; background: var(--flag-green); --i: 0;\"");
    expect(html).toContain("style=\"flex: 3 3 0%; background: var(--flag-yellow); --i: 1;\"");
    expect(html).toContain("style=\"flex: 2 2 0%; background: var(--flag-red); --i: 2;\"");
    expect(html).toContain("style=\"flex: 14 14 0%; background: var(--flag-unknown); --i: 3;\"");
  ...
  it("bands an ocean beach's strip by the ocean thresholds", () => {
    ...
    expect(html).toContain("style=\"flex: 5 5 0%; background: var(--flag-green); --i: 0;\"");
    expect(html).toContain("style=\"flex: 5 5 0%; background: var(--flag-yellow); --i: 1;\"");
    expect(html).not.toContain("background: var(--flag-red);");
