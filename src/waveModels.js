...
// Takes the model id for symmetry with waveSourceLabel and so a per-grid page can
// be added without touching a call site; every id resolves to the one url above.
